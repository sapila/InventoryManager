...
//print_r($row);
	          echo "<div class='orderList'><span style='padding:5px;'>".$row["name"]. " " . $row["boxbought"]. " </span><span style='float:right;'>Κιβώτια : ".$row['boxbought']."<br>Τεμάχια : ".$row['itembought']."</span><br><br></div>";
